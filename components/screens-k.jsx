...
Object.assign(window.MOCK, {
  ...
  publicFaqs: [
    ...
    { cat: 'Registration', q: 'What are the registration schemes and who qualifies?', a: 'Scheme A (High Risk): Equipment with full SDoC and Certificate of Conformity (CoC) from an accredited body. Scheme B (Medium Risk): Equipment requiring detailed technical verification by MCMC. Scheme C (Low Risk): Equipment under a manufacturer\'s self-declaration — qualifying submissions are processed within 1 business day.' },
    { cat: 'Registration', q: 'How long does registration take?', a: 'Scheme C qualifying submissions: same business day. Scheme A/B with officer review: 3–5 working days. Special Approval (non-prohibited): 3–5 working days. Prohibited equipment (multi-level approval): 10–15 working days.' },
  ...
  publicChatHistory: [
    { role: 'bot', t: 'Hello! I am MINA, your NCEF Virtual Assistant. I can help you with equipment registration, certificate verification, fees, and regulatory requirements. How can I help you today?' },
  ],
});
