...
window.MOCK = {
  ...
  // Special Approval pipeline — dedicated SA queue with stage tracking.
  // stage: 'recommendation' | 'verification' | 'approval'
  saQueue: [
    { id: 'SA-0426-00021', applicant: 'Maxis Broadband Sdn Bhd', product: '5G mmWave Test Unit (Nokia AirScale)', category: 'R&D Equipment', submitted: '2026-04-14T09:30:00', aiScore: 65, priority: 'high', slaHours: 8, stage: 'recommendation', assignedRecommender: 'OFF-004', purpose: 'R&D testing — mmWave 26 GHz band', mosteRef: 'MOSTI-2026-0414-001', needsMosti: true },
    { id: 'SA-0426-00022', applicant: 'Celcom Axiata Berhad', product: 'Ericsson 5G NR Radio Unit RU6459', category: 'Network Infrastructure', submitted: '2026-04-15T14:20:00', aiScore: 72, priority: 'normal', slaHours: 36, stage: 'recommendation', assignedRecommender: 'OFF-004', purpose: 'Temporary import for network trial (90 days)', mosteRef: null, needsMosti: false },
    { id: 'SA-0426-00018', applicant: 'TM Technology Services', product: 'Frequency Jammer (R&D Prototype)', category: 'Prohibited Equipment', submitted: '2026-04-08T11:00:00', aiScore: 41, priority: 'critical', slaHours: 4, stage: 'verification', assignedRecommender: 'OFF-004', recommendedBy: 'OFF-004', recommendedAt: '2026-04-10T10:15:00', recommenderNotes: 'Conditionally recommend — applicant holds MOSTI letter. Lab use only, single unit, destruction bond required.', assignedVerifier: 'OFF-005', mosteRef: 'MOSTI-2026-0408-007', needsMosti: true, purpose: 'Academic research — RF interference study' },
    { id: 'SA-0426-00015', applicant: 'Axiata Digital Sdn Bhd', product: 'Huawei AAU 5900 (Massive MIMO)', category: 'Network Infrastructure', submitted: '2026-04-03T13:45:00', aiScore: 81, priority: 'normal', slaHours: 72, stage: 'approval', assignedRecommender: 'OFF-004', recommendedBy: 'OFF-004', recommendedAt: '2026-04-05T09:00:00', recommenderNotes: 'Recommend approval. Documentation complete, MOSTI-endorsed R&D plan provided.', assignedVerifier: 'OFF-005', verifiedBy: 'OFF-005', verifiedAt: '2026-04-07T11:30:00', verifierNotes: 'Verified — recommender findings correct. Escalate to Approver.', assignedApprover: 'OFF-006', mosteRef: 'MOSTI-2026-0403-002', needsMosti: true, purpose: 'Infrastructure deployment trial, East Malaysia' },
    { id: 'SA-0426-00012', applicant: 'Digi Telecommunications', product: 'Spirent TestCenter C100U', category: 'Test Equipment', submitted: '2026-03-28T10:10:00', aiScore: 88, priority: 'low', slaHours: 120, stage: 'approval', assignedRecommender: 'OFF-004', recommendedBy: 'OFF-004', recommendedAt: '2026-03-30T14:00:00', recommenderNotes: 'Recommend — standard network test equipment, no prohibited classification.', assignedVerifier: 'OFF-005', verifiedBy: 'OFF-005', verifiedAt: '2026-04-01T10:30:00', verifierNotes: 'Verified — no issues found.', assignedApprover: 'OFF-006', mosteRef: null, needsMosti: false, purpose: 'Laboratory test & QA equipment' },
  ],
