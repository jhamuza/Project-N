...
const ROLES = [
  {
    ...
    screens: [
      ...
      { key: 'sa-iteration-reply', label: '05-SA-Iteration-Reply' },
      { key: 'modification',      label: '06-Modification-Request' },
      { key: 'importation',       label: '07-Importation' },
      { key: 'certificates',      label: '08-Certificates' },
      { key: 'imei-register',     label: '09-Register-IMEI' },
      { key: 'payments',          label: '10-Payments' },
      { key: 'consultants',       label: '11-Consultants' },
      { key: 'onboarding',        label: '12-Supplier-Onboarding' },
      { key: 'notifications',     label: '13-Notifications' },
      { key: 'profile',           label: '14-Profile-Settings' },
    ],
  },
  {
    id: 'team-lead',
